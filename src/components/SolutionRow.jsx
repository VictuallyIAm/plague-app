    ...
    <tr key={item.id} className={isExpanded ? '' : 'h-24'}>
      <td className="border-1 align-top py-4 text-xl font-bold w-1/4">
        <div className="flex items-start justify-center md:items-center">
          <img src={list} alt="logo" className="md:hidden" />
          <p className="mx-3 text-lg md:text-sm">{item.title}</p>
          <IoIosArrowDown
            size={40}
            color="green"
      ...
      <td className="border-1 align-top py-4 text-xl md:text-sm font-bold text-textBlack bg-bgFeatOne w-1/4">
      ...
      <td className="border-1 align-top py-4 text-xl md:text-sm font-bold text-textBlack bg-bgFeatOTwo w-1/4">
      ...
      <td className="border-1 align-top py-4 text-xl md:text-sm font-bold text-textBlack bg-bgFeatThree w-1/4">
